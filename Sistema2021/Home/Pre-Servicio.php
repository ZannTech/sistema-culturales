...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Administración de registros a el servicio social</h1>
    </div>
    <div class="row">
...
?>
<script src="../../config/core/ajax.controller/ajax.controller.servicio.js"></script>